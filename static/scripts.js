...
$(function() {
    ...
    var options = {
        center: {lat: 42.6803413, lng: -73.8240858},// UAlbany, New York
...
function addMarker(place)
{
    ...
    var img = {
        ...
        labelOrigin: new google.maps.Point(38, 38)
    };
    ...
    var marker = new google.maps.Marker({
        ...
        if ($.isEmptyObject(data)){
            ...
            {
            articleLinks += template({link: data[i].link,
                title: data[i].title
            });
            }
        }
